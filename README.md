...
```
cd existing_repo
git remote add origin https://gitlab.code.hfactory.io/victor.hoffmann/hackathon-team-5.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.code.hfactory.io/victor.hoffmann/hackathon-team-5/-/settings/integrations)
